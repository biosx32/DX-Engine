...
namespace Colors
{
	...
	static constexpr Color GrayLight = D3DCOLOR_XRGB(0xABu, 0xABu, 0xABu);
	static constexpr Color GrayLightLight = D3DCOLOR_XRGB(0xDFu, 0xDFu, 0xDFu);
	static constexpr Color Red = D3DCOLOR_XRGB(255u, 0u, 0u);
	static constexpr Color RedDark = D3DCOLOR_XRGB(127u, 0u, 0u);
	static constexpr Color Green = D3DCOLOR_XRGB(0u, 255u, 0u);
	static constexpr Color GreenDark = D3DCOLOR_XRGB(0u, 127u, 0u);
	static constexpr Color GreenLime = D3DCOLOR_XRGB(50u, 205u, 50u);
